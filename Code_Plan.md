...
KR PoC에서는 사용자가 이미 수집한 원본 뉴스 파일  
`data/samsung_mk_news_20260201_20260331.pkl`을 사용한다.

Stage 1-5는 웹 스크래핑이 아니라, 이 파일을 검증하고 TwinMarket 뉴스 포맷과 호환되도록 변환하는 단계로 변경한다.
